# 1 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiBase.c"
...
# 2 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiBase.c" 2
...
# 3 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiBase.c" 2
...
# 4 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiBase.c" 2
...
static const TBounds g_guiBounds = {{0, 0, 32 - 1, 24 - 1}};
static u8 g_heap[(16*(1<<10))] __attribute__((aligned (32)));
static u32 g_heapPos = 0;
static TGuiFrameEntry g_stack[4];
static u32 g_stackPos = 0;

static const TGuiTypeHeader* g_layoutType = ((void *)0);
...
void guiSystemInit()
{
 ...
 g_stackPos = 0;
 g_heapPos = 0;
 memset(g_stack, 0, sizeof(TGuiFrameEntry) * 4);
 for(i = 0; i < 4; i++) {
  g_stack[i].pRoot = ((void *)0);
  g_stack[i].heapPos = 0;
 }
 guiRenderInit();
...
void guiSystemRender()
{
 guiBroadcastEvent(GUIEVENT_RENDER, ((void *)0));
}
...
static void guiSystemProcessCommand()
{
 ...
 case GUICOMMAND_PUSH:
  guiRenderClear();
  guiBroadcastEvent(GUIEVENT_DISABLE, ((void *)0));
  g_stackPos++;
  pFrame = &g_stack[g_stackPos];
  pFrame->heapPos = g_heapPos;
  pFrame->pRoot = guiObjAllocChild_r(g_layoutType, ((void *)0), &g_guiBounds);

  guiObjSendEvent(pFrame->pRoot, GUIEVENT_CREATE, ((void *)0));

  guiObjSendEvent(pFrame->pRoot, GUIEVENT_ENABLE, ((void *)0));
  break;
 case GUICOMMAND_POP:

  guiBroadcastEvent(GUIEVENT_DISABLE, ((void *)0));

  guiBroadcastEvent(GUIEVENT_DESTROY, ((void *)0));
  guiRenderClear();
  pFrame = &g_stack[g_stackPos];
  g_heapPos = pFrame->heapPos;
  g_stackPos--;
  guiBroadcastEvent(GUIEVENT_ENABLE, ((void *)0));
  break;
 case GUICOMMAND_NEW:
  guiBroadcastEvent(GUIEVENT_DISABLE, ((void *)0));
  guiBroadcastEvent(GUIEVENT_DESTROY, ((void *)0));
...
void guiSystemProcess()
{
 static TGuiObject* pTouchDownObj = ((void *)0);
     ...
     const TBounds* pBounds)
{
 ...
 guiObjSendEvent(this, GUIEVENT_CREATE, ((void *)0));
 return this;
}
