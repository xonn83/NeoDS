# 1 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c"
...
# 2 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2
...
# 5 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/include/NeoMemory.h" 1
# 6 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/include/NeoCpu.h" 1
# 7 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2
...
# 8 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 9 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2
...
# 10 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c" 2


void neoFixedInit();
void neoFixedExit();
void __attribute__((section(".itcm"), long_call)) neoDrawFixed();
void neoLoadTiles();
...
u16 g_frameCount __attribute__((section(".sbss")));
static volatile u16 g_framePending = 0;

static const TNeoVideoBounds g_videoBoundsList[] = {
 {32, (16 + 16) << 4, (256 + 32 - 1), (192 + 16 + 16 - 1) << 4},
 {8, (0 + 16) << 4, (304 + 8 - 1), (224 + 16 - 1) << 4},
};
TNeoVideoBounds g_videoBounds __attribute__((section(".sbss")));
...
# 88 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c"
static void vblankIntr()
{
 ...
 if(g_size != NEOVIDEO_NORMAL) {
  (*((bg_attribute *)0x04000008)).bg2_rotation.dx = g_neo->tileOffsetX + jitter4[sIndex + 0];
  (*((bg_attribute *)0x04000008)).bg2_rotation.dy = g_neo->tileOffsetY + jitter4[sIndex + 1];
  (*((bg_attribute *)0x04000008)).bg3_rotation.dx = g_neo->tileOffsetX + jitter4[sIndex + 2];
  (*((bg_attribute *)0x04000008)).bg3_rotation.dy = g_neo->tileOffsetY + jitter4[sIndex + 3];
  sIndex += 4;
  if(sIndex >= 8) sIndex = 0;
 } else {
  (*((bg_attribute *)0x04000008)).bg2_rotation.dx = g_neo->tileOffsetX;
  (*((bg_attribute *)0x04000008)).bg2_rotation.dy = g_neo->tileOffsetY;
  (*((bg_attribute *)0x04000008)).bg3_rotation.dx = g_neo->tileOffsetX;
  (*((bg_attribute *)0x04000008)).bg3_rotation.dy = g_neo->tileOffsetY;
 }

 (*((bg_attribute *)0x04000008)).bg2_rotation.xdx = g_neo->tileScaleX;
 (*((bg_attribute *)0x04000008)).bg2_rotation.ydy = g_neo->tileScaleY;
 (*((bg_attribute *)0x04000008)).bg3_rotation.xdx = g_neo->tileScaleX;
 (*((bg_attribute *)0x04000008)).bg3_rotation.ydy = g_neo->tileScaleY;
...
static void vcountIntr()
{
 ...
 if(g_framePending == 1 && (*(volatile u16*)0x4000006) < 192) {
  (*(vu32*) 0x04000540) = 0;
  g_framePending = 2;
 }
 g_neo = (TNeoContext*)saveR7;
...
bool neoVideoInit()
{
 ...
 (*(vu32*) 0x04000480) = 0x7fff;

 (*(vu32*) 0x04000350) = 0;
 (*(vu16*) 0x04000354) = 0x7fff;
...
# 263 "C:/Users/GRX/NeoDS/arm9/source/NeoVideo.c"
...
void neoVideoDrawFrame()
{
 ...
 if(g_videoBounds.minX != pTarget->minX || g_videoBounds.maxX != pTarget->maxX ||
  g_videoBounds.minY != pTarget->minY || g_videoBounds.maxY != pTarget->maxY) {
   ...
   if(g_videoBounds.minY < pTarget->minY) g_videoBounds.minY += (1 << 4);
   else if(g_videoBounds.minY > pTarget->minY) g_videoBounds.minY -= (1 << 4);

   if(g_videoBounds.maxY < pTarget->maxY) g_videoBounds.maxY += (1 << 4);
   else if(g_videoBounds.maxY > pTarget->minY) g_videoBounds.maxY -= (1 << 4);
