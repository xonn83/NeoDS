...
.LVL1:
	...
	bx	lr
.LFE166:
	.size	linearHeapInit, .-linearHeapInit
	.align	2
	.global	linearHeapAlloc
	.code	16
	.thumb_func
	.type	linearHeapAlloc, %function
linearHeapAlloc:
.LFB167:
	.loc 1 13 0
	push	{lr}
...
.LVL7:
	...
	pop	{pc}
.LFE167:
	.size	linearHeapAlloc, .-linearHeapAlloc
	.align	2
	.global	linearHeapReset
	.code	16
	.thumb_func
	.type	linearHeapReset, %function
linearHeapReset:
.LFB168:
	.loc 1 27 0
.LVL8:
	...
	bx	lr
.LFE168:
	.size	linearHeapReset, .-linearHeapReset
	.align	2
	.global	linearHeapClear
	.code	16
	.thumb_func
	.type	linearHeapClear, %function
linearHeapClear:
.LFB169:
	.loc 1 33 0
	push	{lr}
...
.L11:
	...
	pop	{pc}
.LFE169:
	.size	linearHeapClear, .-linearHeapClear
	.align	2
	.global	linearHeapGetFree
	.code	16
	.thumb_func
	.type	linearHeapGetFree, %function
linearHeapGetFree:
.LFB170:
	.loc 1 42 0
.LVL11:
...
.LVL12:
	...
	bx	lr
.LFE170:
	.size	linearHeapGetFree, .-linearHeapGetFree
...
.LLST9:
	...
	.4byte	0xee5
	.4byte	0xd1f
	.ascii	"linearHeapInit\000"
	.4byte	0xd66
	.ascii	"linearHeapAlloc\000"
	.4byte	0xdb1
	.ascii	"linearHeapReset\000"
	.4byte	0xdd6
	.ascii	"linearHeapClear\000"
	.4byte	0xe15
	.ascii	"linearHeapGetFree\000"
	.4byte	0xec1
	.ascii	"g_neo\000"
	.4byte	0x0
