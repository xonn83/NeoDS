# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
# 6 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
# 7 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
# 8 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
# 9 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2
...
# 10 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/LayoutRomSelect.c" 2

static TGuiEventReturn romMenuHandler (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiMenu* this __attribute__ ((unused)) = (TGuiMenu*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
break; } case GUIEVENT_SELECTED: { TGUIEVENT_SELECTEDArg* arg __attribute__ ((unused)) = (TGUIEVENT_SELECTEDArg*)__arg__;
{
 ...
 ((volatile TNeoIPC*)0x027FF400)->globalAudioEnabled = pLayout->globalAudioEnabled;
...
static TGuiEventReturn cancelHandler (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiButton* this __attribute__ ((unused)) = (TGuiButton*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
break; } case GUIEVENT_SELECTED: { TGUIEVENT_SELECTEDArg* arg __attribute__ ((unused)) = (TGUIEVENT_SELECTEDArg*)__arg__;
{
 guiFramePop();
 __ret__ = GUIEVENTRET_HANDLED;
...
static TGuiEventReturn audioEnableHandler (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiCheckbox* this __attribute__ ((unused)) = (TGuiCheckbox*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
break; } case GUIEVENT_SELECTED: { TGUIEVENT_SELECTEDArg* arg __attribute__ ((unused)) = (TGUIEVENT_SELECTEDArg*)__arg__;
{
 TGuiLayoutRomSelect* pLayout = (TGuiLayoutRomSelect*)guiGetRoot();
...
extern const TGuiTypeHeader __TGuiObjectTypeHeader__; static TGuiEventReturn __TGuiLayoutRomSelectTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__); const TGuiTypeHeader __TGuiLayoutRomSelectTypeHeader__ = { __TGuiLayoutRomSelectTypeHandler__, &__TGuiObjectTypeHeader__, sizeof(TGuiLayoutRomSelect), "TGuiLayoutRomSelect" }; static TGuiEventReturn __TGuiLayoutRomSelectTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiLayoutRomSelect* this __attribute__ ((unused)) = (TGuiLayoutRomSelect*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
break; } case GUIEVENT_CREATE: { TGUIEVENT_CREATEArg* arg __attribute__ ((unused)) = (TGUIEVENT_CREATEArg*)__arg__;
{
 ...
 this->globalAudioEnabled = ((volatile TNeoIPC*)0x027FF400)->globalAudioEnabled;
 this->romEnabled = g_neo->active;

 pFrame = ((TGuiLabel*)guiObjCreateChild_r(&__TGuiLabelTypeHeader__, guiGetRoot(), &frameBounds));
 ...
 TGuiLabel* pLabel = ((TGuiLabel*)guiObjCreateChild_r(&__TGuiLabelTypeHeader__, (TGuiObject*)pFrame, &headerBounds));
 guiLabelSetText(pLabel, "Select Rom");

 TGuiButton* pCancel = ((TGuiButton*)guiObjCreateChild_r(&__TGuiButtonTypeHeader__, guiGetRoot(), &cancelBounds));
 guiLabelSetText(&pCancel->parent, "Cancel");
 guiObjSetHandler(&pCancel->parent.parent, cancelHandler);

 TGuiCheckbox* pAudioEnable = ((TGuiCheckbox*)guiObjCreateChild_r(&__TGuiCheckboxTypeHeader__, guiGetRoot(), &audioBounds));
 guiLabelSetText((TGuiLabel*)pAudioEnable, "Audio");
 guiCheckboxSetChecked(pAudioEnable, ((volatile TNeoIPC*)0x027FF400)->globalAudioEnabled);
