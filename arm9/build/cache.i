# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c"
# 1 "C:\\Users\\GRX\\NeoDS-GBMacro\\arm9\\build//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c"
# 36 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c"
...
# 37 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c" 2
...
# 39 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c" 2
...
# 40 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c" 2
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/disc_io/disc.h" 1
# 37 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/disc_io/disc.h"
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/disc_io/disc_io.h" 1
...
# 41 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c" 2
...
# 43 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/cache.c" 2
...
CACHE* _FAT_cache_constructor (u32 numberOfPages, const IO_INTERFACE* discInterface) {
 ...
 for (i = 0; i < numberOfPages; i++) {
  cacheEntries[i].sector = 0xFFFFFFFF;
 ...
 cache->pages = (u8*) _FAT_mem_allocate ( 512 * numberOfPages);
 if (cache->pages == 0) {
...
static u32 _FAT_cache_getSector (CACHE* cache, u32 sector) {
 ...
 for (i = 0; (i < numberOfPages) && (cacheEntries[i].sector != sector); i++) {
  ...
  if ( (cacheEntries[i].sector == 0xFFFFFFFF) || (cacheEntries[i].count < lowestCount) ) {
   leastUsed = i;
 ...
 if ((cacheEntries[leastUsed].sector != 0xFFFFFFFF) && (cacheEntries[leastUsed].dirty == true)) {

  if (!_FAT_disc_writeSectors (cache->disc, cacheEntries[leastUsed].sector, 1, cache->pages + 512 * leastUsed)) {
   return 0xFFFFFFFF;
  }
 ...
 if (!_FAT_disc_readSectors (cache->disc, sector, 1, cache->pages + 512 * leastUsed)) {
  return 0xFFFFFFFF;
 }
...
bool _FAT_cache_readPartialSector (CACHE* cache, void* buffer, u32 sector, u32 offset, u32 size) {
 ...
 memcpy (buffer, cache->pages + (512 * page) + offset, size);
 return true;
}
...
bool _FAT_cache_writePartialSector (CACHE* cache, const void* buffer, u32 sector, u32 offset, u32 size) {
 ...
 memcpy (cache->pages + (512 * page) + offset, buffer, size);
...
bool _FAT_cache_eraseWritePartialSector (CACHE* cache, const void* buffer, u32 sector, u32 offset, u32 size) {
 ...
 memset (cache->pages + (512 * page), 0, 512);
 memcpy (cache->pages + (512 * page) + offset, buffer, size);
 cache->cacheEntries[page].dirty = true;
...
bool _FAT_cache_flush (CACHE* cache) {
 ...
 for (i = 0; i < cache->numberOfPages; i++) {
  if (cache->cacheEntries[i].dirty) {
   if (!_FAT_disc_writeSectors (cache->disc, cache->cacheEntries[i].sector, 1, cache->pages + 512 * i)) {
    return 0xFFFFFFFF;
   }
  }
...
void _FAT_cache_invalidate (CACHE* cache) {
 int i;
 for (i = 0; i < cache->numberOfPages; i++) {
  cache->cacheEntries[i].sector = 0xFFFFFFFF;
  cache->cacheEntries[i].count = 0;
  cache->cacheEntries[i].dirty = false;
 }
}
