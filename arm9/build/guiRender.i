# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiRender.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiRender.c" 2
...
void guiRenderClear();
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiRender.c" 2


extern const u8 gui_bin[];
extern const int gui_bin_size;
# 16 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiRender.c"
static const u16 g_palette[256] = {
 (((0)>>3)|(((0)>>3)<<5)|(((0)>>3)<<10)),
 (((152)>>3)|(((152)>>3)<<5)|(((152)>>3)<<10)),
 (((32)>>3)|(((32)>>3)<<5)|(((32)>>3)<<10)),
 (((120)>>3)|(((120)>>3)<<5)|(((120)>>3)<<10)),
 (((96)>>3)|(((96)>>3)<<5)|(((96)>>3)<<10)),
 (((72)>>3)|(((72)>>3)<<5)|(((72)>>3)<<10)),
 (((176)>>3)|(((176)>>3)<<5)|(((176)>>3)<<10)),
 (((200)>>3)|(((200)>>3)<<5)|(((200)>>3)<<10)),
 (((224)>>3)|(((224)>>3)<<5)|(((224)>>3)<<10)),
 (((112)>>3)|(((112)>>3)<<5)|(((112)>>3)<<10)),
 (((248)>>3)|(((248)>>3)<<5)|(((248)>>3)<<10)),
 (((0)>>3)|(((0)>>3)<<5)|(((0)>>3)<<10)),
 (((0)>>3)|(((0)>>3)<<5)|(((0)>>3)<<10)),
 (((0)>>3)|(((0)>>3)<<5)|(((0)>>3)<<10)),
 (((0)>>3)|(((0)>>3)<<5)|(((0)>>3)<<10)),
 ...
 (((255)>>3)|(((0)>>3)<<5)|(((255)>>3)<<10)),
 (((0)>>3)|(((0)>>3)<<5)|(((0)>>3)<<10)),
 (((255)>>3)|(((255)>>3)<<5)|(((255)>>3)<<10)),
 (((128)>>3)|(((128)>>3)<<5)|(((128)>>3)<<10)),
 (((96)>>3)|(((96)>>3)<<5)|(((96)>>3)<<10)),
};
...
void guiRenderInit()
{
 ...
 videoSetModeSub(0x10000 | (1 << 8) | (1 << 9));


 (*(vuint16*)0x04001008) = ((20) << 8) | ((2) << 2);
 (*(vuint16*)0x04001010) = -4;
 (*(vuint16*)0x04001012) = -4;


 (*(vuint16*)0x0400100A) = ((21) << 8) | ((2) << 2);
 (*(vuint16*)0x04001014) = 0;
 (*(vuint16*)0x04001016) = 0;


 for(i = 0; i < 256; i++) {
  ((uint16*)0x05000400)[i] = g_palette[i];
 }

 DC_FlushAll();


 dmaCopy(gui_bin, ((u16*)(((2)*0x4000)+ 0x06200000)), gui_bin_size);
}
...
{
 const u32 width = 12;
 const u32 stride = 32 - width;
 u16* pDst = &((u16*)(((21)*0x800) + 0x06200000))[y0 * 32 + x0];
 s32 x;
...
void guiRenderFrame(s32 x, s32 y, s32 w, s32 h, TGuiBorderStyle style)
{
 s32 x0;
 s32 y0;
 u16* pDst = &((u16*)(((21)*0x800) + 0x06200000))[y * 32 + x];
 u32 tile = 0;
...
void guiRenderChar(s32 x, s32 y, char c)
{
 ((void)0);
 ((void)0);
 u16* pDst = &((u16*)(((20)*0x800) + 0x06200000))[y * 32 + x];
 *pDst = c;
}
...
void guiRenderVertString(s32 x, s32 y, const char* szString)
{
  ...
  *pDst = *szString++;
  ...
  if(x >= 24 - 1) {
   y = 0;
   x++;
   pDst = &((u16*)(((20)*0x800) + 0x06200000))[x];
  }
 }
}
...
void guiRenderString(s32 x, s32 y, const char* szString)
{
  ...
  *pDst++ = *szString++;
  ...
  if(x >= 32 - 1) {
   x = 0;
   y++;
   pDst = &((u16*)(((20)*0x800) + 0x06200000))[y * 32];
  }
 }
}
...
void guiRenderClearBounds(const TBounds* pBounds)
{
 ...
 for(y = pBounds->y0; y <= pBounds->y1; y++) {
  u16* pDst0 = &((u16*)(((21)*0x800) + 0x06200000))[y * 32 + pBounds->x0];
  u16* pDst1 = &((u16*)(((20)*0x800) + 0x06200000))[y * 32 + pBounds->x0];
  for(x = 0; x < width; x++) {
   *pDst0++ = 0;
   *pDst1++ = 0;
  }
...
void guiRenderClear()
{
 u16* pDst0 = &((u16*)(((21)*0x800) + 0x06200000))[0];
 u16* pDst1 = &((u16*)(((20)*0x800) + 0x06200000))[0];
 s32 i;
 for(i = 0; i < (32 * 24); i++) {
  *pDst0++ = 0;
  *pDst1++ = 0;
