# 1 "C:/Users/GRX/NeoDS-master-old/arm9/source/NeoProtection.c"
...
# 2 "C:/Users/GRX/NeoDS-master-old/arm9/source/NeoProtection.c" 2

# 1 "C:/Users/GRX/NeoDS-master-old/arm9/include/NeoMemory.h" 1
# 4 "C:/Users/GRX/NeoDS-master-old/arm9/source/NeoProtection.c" 2


static u16 g_pvcRam[0x1000] __attribute__((aligned (32)));
 ...
 *(((u8*)g_pvcRam) + (0x1ff3)) &= 0x7f;
 ...
 if(bankaddress >= g_neo->romBankCount * (1<<20)) {
  ((void)0);
  bankaddress = 0;
 }
...
static u8 neoReadPvc8(u32 a)
{
 a &= 0x00ffffff;
 if(a >= 0x2fe000) {
  return (*((u8*)(g_pvcRam) + ((a - 0x2fe000) ^ 1)));
 }
...
static u16 neoReadPvc16(u32 a)
{
 a &= 0x00ffffff;
 if(a >= 0x2fe000) {
  return (*(u16*)((u8*)(g_pvcRam) + (a - 0x2fe000)));
 }
 return neoReadBankedRom16(a);
}
# 91 "C:/Users/GRX/NeoDS-master-old/arm9/source/NeoProtection.c"
static void neoWritePvc8(u32 a, u8 d)
{
 a &= 0x00ffffff;
 if(a >= 0x2fe000) {
  const u32 offset = (a - 0x2fe000) >> 1;
  *((u8*)(g_pvcRam) + ((a - 0x2fe000) ^ 1)) = (u8)(d);
...
static void neoWritePvc16(u32 a, u16 d)
{
 ...
 if(a >= 0x2fe000) {
  const u32 offset = (a - 0x2fe000) >> 1;
  *(u16*)((u8*)(g_pvcRam) + (a - 0x2fe000)) = (u16)(d);
  if(offset == 0xff0) neoPvcProt1();
  else if(offset >= 0xff4 && offset <= 0xff5) neoPvcProt2();
  else if(offset >= 0xff8) neoPvcWriteBank();
 } else {
...
# 126 "C:/Users/GRX/NeoDS-master-old/arm9/source/NeoProtection.c"
...
void neoInstallProtection()
{
 ...
 case NEOPROT_PVC:
  ...
  g_neo->cpuWrite32Table[0x2f] = neoDefaultWrite32;
