# 1 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c"
...
# 2 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
# 1 "C:/devkitPro/libnds/include/fat.h" 1
# 43 "C:/devkitPro/libnds/include/fat.h"
# 1 "C:/devkitPro/libnds/include/nds/disc_io.h" 1
# 40 "C:/devkitPro/libnds/include/nds/disc_io.h"
...
# 44 "C:/devkitPro/libnds/include/fat.h" 2
...
# 74 "C:/devkitPro/libnds/include/fat.h"
...
# 3 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
...
# 4 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
...
bool neoSaveConfig();
# 9 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/source/NeoSystemAsm.h" 1



# 1 "C:/Users/GRX/NeoDS/arm9/include/NeoMemory.h" 1
# 5 "C:/Users/GRX/NeoDS/arm9/source/NeoSystemAsm.h" 2
# 10 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/include/pd4990a.h" 1
...
# 11 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/include/NeoCpu.h" 1
# 12 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
...
# 13 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
...
# 15 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2

# 1 "C:/Users/GRX/NeoDS/arm9/source/NeoProfiler.h" 1
...
# 17 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/source/LinearHeap.h" 1
...
# 18 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 5 "C:/Users/GRX/NeoDS/arm9/source/guiConsole.h" 2
...
# 19 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c" 2
...
struct __STATICASSERTSTRUCT25__ { u8 staticAssert[(sizeof(TNeoContext) == ((((((((0x400) + 256*4) + 256*4) + 256*4) + 256*4) + 256*4) + 256*4) + 256*4)) - 1]; };

struct __STATICASSERTSTRUCT27__ { u8 staticAssert[(((u32)(&((TNeoContext*)0)->varEnd) - (u32)((TNeoContext*)0)) == ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((0 +0xb0)+36)+4)+4) + 12 * 7) + 12)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+64)+4)+4)+4)+2)+2)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+4)+1)+1)+1)+1)+1)+1)+1)+8)+1)) - 1]; };

struct __STATICASSERTSTRUCT29__ { u8 staticAssert[(((u32)(&((TNeoContext*)0)->cpuRead8Table) - (u32)((TNeoContext*)0)) == 0x400) - 1]; };

TNeoContext g_neoContext __attribute__((section(".sbss")));
...
static char* g_romNames[64];
static s32 g_pauseCount = 0;
static bool g_paused = false;
# 58 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c"
void neoSystemIPCSync()
{
# 68 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c"
}
...
void neoSystemLoadSprite(u8* pDst, u32 index)
{
 const u32 romOffset =
  ...
  index * ((1 << 3) * 128);
 neoSystemReadRom(pDst, romOffset, ((1 << 3) * 128));
}
...
void neoSystemLoadSprite2(u8* pDst, u32 index)
{
 const u32 romOffset =
  g_header.romEntry[NEOROM_SPRITEDATA].offset +
  index * ((1 << 5) * 128);
 neoSystemReadRom(pDst, romOffset, ((1 << 5) * 128));
}
...
void neoSystemLoadTile(u8* pDst, u32 index)
{
 const u32 romOffset =
  ...
  index * (4 * 64);
 neoSystemReadRom(pDst, romOffset, (4 * 64));
}
...
void neoSystemSetClockDivide(u32 clock)
{
 ...
 g_neo->cpuClocksPerScanline = (384 * 4 / (g_neo->cpuClockDivide));
}
# 187 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c"
...
bool neoSystemInit()
{
 ...
 linearHeapInit(&g_vramHHeap, (void*)0x6898000, 32*(1<<10));
 ...
 while(g_romCount < 64 && dirnext(dir, szFilename, &st) == 0) {
...
bool neoSystemOpen(const char* szFileName)
{
 ...
 if(header.magic != 0x7e0116e0 ||
  header.version != 0 ||
  header.sectionCount != NEOROM_COUNT) {

  systemClose(rom);
  guiConsoleLogf(" -> invalid rom");
  guiConsoleLogf(" -> magic %08X / %08X", header.magic, 0x7e0116e0);
  guiConsoleLogf(" -> version %d / %d", header.version, 0);
 ...
 g_romSize = systemFileSize(rom) - 512;
 g_header = header;
 g_rom = rom;
 ...
 ((volatile TNeoIPC*)0x027FF400)->audioResult = 0;
 ...
 g_neo->spriteCount = g_header.romEntry[NEOROM_SPRITEDATA].size / 128;
 ...
 const s32 bankSize = (s32)g_header.romEntry[NEOROM_MAINPROGRAM].size - 1*(1<<20);
 if(bankSize > 0) {
  g_neo->romBankCount = bankSize / (1*(1<<20));
  if(g_neo->romBankCount * 1*(1<<20) != bankSize) {
   g_neo->romBankCount++;
 ...
 if(((volatile TNeoIPC*)0x027FF400)->globalAudioEnabled) {
  ...
  ((volatile TNeoIPC*)0x027FF400)->audioResult = 1;
 }
 cpuReset();
...
void neoSystemSetEnabled(bool enable)
{
 ...
 ((void)0);
# 463 "C:/Users/GRX/NeoDS/arm9/source/NeoSystem.c"
}
...
static void neoDoInput(u32 mask, bool pressed)
{
 ...
 if(g_neo->active) {
  if(mask & (1 << 0)) ctrl1Reg &= ~(1 << 12);
  if(mask & (1 << 1)) ctrl1Reg &= ~(1 << 13);
  if(mask & (1 << 2)) ctrl1Reg &= ~(1 << 14);
  if(mask & (1 << 3)) ctrl1Reg &= ~(1 << 15);
  if(mask & (1 << 4)) ctrl3Reg &= ~(1 << 8);
  if(mask & (1 << 5)) ctrl3Reg &= ~(1 << 9);
  if(mask & (1 << 6)) coinReg &= ~(1 << 0);
 }
...
static void neoSystemDoFrame()
{
 ...
 g_neo->scanline = 0;
 cpuExecute((384 * 4 / (g_neo->cpuClockDivide)));
 ...
 g_neo->ctrl3Reg = 0xcf00;




 g_neo->coinReg = 0x0007 |
