# 1 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoPalette.arm.c"
...
# 2 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoPalette.arm.c" 2
...
# 3 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoPalette.arm.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/include/NeoMemory.h" 1
# 4 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoPalette.arm.c" 2
...
void neoUpdatePalette()
{
 ...
 (*(vu32*) 0x04000350) = g_nitroPalette[g_neo->paletteBank + 0x0fff] | (0x1f << 16);
}
...
void neoLoadPalette()
{
 if(g_endTransfer > g_startTransfer) {
  ...
  u16* restrict pDst = ((u16*)0x6894000) + g_startTransfer * 16;
 ...
 if(g_loadFixed) {
  ...
  u32* restrict pDst0 = (u32*)(((u16*)0x6890000));
  u32* restrict pDst1 = (u32*)((u8*)((u16*)0x6890000) + 8*(1<<10));
  s32 i;
