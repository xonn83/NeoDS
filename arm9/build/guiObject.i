# 1 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiObject.c"
...
# 2 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiObject.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 3 "C:/Users/GRX/NeoDS-master-old/arm9/source/guiObject.c" 2

static TGuiEventReturn __TGuiObjectTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__)
{
 return GUIEVENTRET_NOTHANDLED;
}

const TGuiTypeHeader __TGuiObjectTypeHeader__ = {
...
TGuiEventReturn guiObjSendEvent(TGuiObject* this, TGuiEventID e, void* arg)
{
 ...
 while(ret == GUIEVENTRET_NOTHANDLED && pType != ((void *)0)) {
