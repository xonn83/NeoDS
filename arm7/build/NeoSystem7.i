# 1 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c" 2
...
void neoZ80Reset();
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c" 2
...
# 4 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c" 2
...
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c" 2
...
# 6 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c" 2
...
# 7 "C:/Users/GRX/NeoDS-GBMacro/arm7/source/NeoSystem7.c" 2
...
{
 u32 value = readPowerManagement(0);
 writePowerManagement(0, value & ~(1 << (3)));
}
...
static void neoBacklightOff()
{
 ...
 u32 value = readPowerManagement(0);
 writePowerManagement(0, value & ~(1 << (2)));
...
static void neoLidClose()
{
 u32 enabled = (*(vuint16*)0x04000208);
 (*(vuint16*)0x04000208) = 0;
 const u32 powerValue = readPowerManagement(0);
 u32 value = powerValue;
 value &= ~((1 << (2)) | (1 << (3)));
 value |= (1<<4);
 writePowerManagement(0, value);
 (*(vuint16*)0x04000208) = enabled;
 ...
 enabled = (*(vuint16*)0x04000208);
 (*(vuint16*)0x04000208) = 0;
 writePowerManagement(0, powerValue);
 (*(vuint16*)0x04000208) = enabled;
