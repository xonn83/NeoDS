# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/../common/source/NeoIPC.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/../common/source/NeoIPC.c" 2
...
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/../common/source/NeoIPC.c" 2
...
# 7 "C:/Users/GRX/NeoDS-GBMacro/arm9/../common/source/NeoIPC.c" 2
...
# 8 "C:/Users/GRX/NeoDS-GBMacro/arm9/../common/source/NeoIPC.c" 2

struct __STATICASSERTSTRUCT9__ { u8 staticAssert[(sizeof(TNeoIPC) <= 2048) - 1]; };
# 21 "C:/Users/GRX/NeoDS-GBMacro/arm9/../common/source/NeoIPC.c"
enum {
 IPCSTATE_IDLE,
 IPCSTATE_RECVD,
};
...
u32 neoIPCSendCommandAsync(TNeoIPCCommand command)
{
 ...
 ((volatile TNeoIPC*)0x027FF400)->arm9FifoSent++;

 return ((volatile TNeoIPC*)0x027FF400)->arm9FifoSent;
...
bool neoIPCCheckCommandDone(u32 message)
{
 ...
 const u32 processed = ((volatile TNeoIPC*)0x027FF400)->arm7FifoProcessed;
...
void neoIPCAckCommand()
{
 ...
 ((volatile TNeoIPC*)0x027FF400)->arm9FifoProcessed++;
