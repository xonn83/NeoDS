# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiButton.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiButton.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiButton.c" 2
...
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiButton.c" 2

extern const TGuiTypeHeader __TGuiLabelTypeHeader__; static TGuiEventReturn __TGuiButtonTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__); const TGuiTypeHeader __TGuiButtonTypeHeader__ = { __TGuiButtonTypeHandler__, &__TGuiLabelTypeHeader__, sizeof(TGuiButton), "TGuiButton" }; static TGuiEventReturn __TGuiButtonTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiButton* this __attribute__ ((unused)) = (TGuiButton*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
...
break; } case GUIEVENT_TOUCHDOWN: { TGUIEVENT_TOUCHDOWNArg* arg __attribute__ ((unused)) = (TGUIEVENT_TOUCHDOWNArg*)__arg__;
{
...
break; } case GUIEVENT_TOUCHUP: { TGUIEVENT_TOUCHUPArg* arg __attribute__ ((unused)) = (TGUIEVENT_TOUCHUPArg*)__arg__;
{
 this->state = GUIBUTTON_NORMAL;
 guiObjRenderDirty(&this->parent.parent);
 __ret__ = GUIEVENTRET_HANDLED;
