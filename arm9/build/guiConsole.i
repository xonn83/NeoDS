# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiConsole.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiConsole.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiConsole.c" 2
...
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiConsole.c" 2




static char g_log[32 * 24] __attribute__((aligned (32)));
static u32 g_line = 0;
static u32 g_logCount = 0;

extern const TGuiTypeHeader __TGuiObjectTypeHeader__; static TGuiEventReturn __TGuiConsoleTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__); const TGuiTypeHeader __TGuiConsoleTypeHeader__ = { __TGuiConsoleTypeHandler__, &__TGuiObjectTypeHeader__, sizeof(TGuiConsole), "TGuiConsole" }; static TGuiEventReturn __TGuiConsoleTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiConsole* this __attribute__ ((unused)) = (TGuiConsole*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
...
break; } case GUIEVENT_RENDER: { TGUIEVENT_RENDERArg* arg __attribute__ ((unused)) = (TGUIEVENT_RENDERArg*)__arg__;
{
 ...
 for(y = 0; y < height; y++) {
  ((void)0);
  guiRenderStringn(bounds.x0, bounds.y0 + y, 32 - 1, &g_log[line * 32]);
  line++;
  if(line >= 24) line -= 24;
 }
...
break; } case GUIEVENT_PROCESS: { TGUIEVENT_PROCESSArg* arg __attribute__ ((unused)) = (TGUIEVENT_PROCESSArg*)__arg__;
{
...
void guiConsoleDump()
{
 ...
 for(y = 0; y < 24 - 1; y++) {
  guiRenderStringn(0, y, 32 - 1, &g_log[line * 32]);
  line++;
  if(line >= 24) line -= 24;
 }
}
