# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
...
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/include/NeoMemory.h" 1
# 6 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/include/NeoCpu.h" 1
# 7 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
...
# 8 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 9 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
...
# 10 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c" 2
...
# 88 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c"
static void vblankIntr()
{
 ...
 if(g_size != NEOVIDEO_NORMAL) {
  (*(vuint32*)0x04000028) = g_neo->tileOffsetX + jitter4[sIndex + 0];
  (*(vuint32*)0x0400002C) = g_neo->tileOffsetY + jitter4[sIndex + 1];
  (*(vuint32*)0x04000038) = g_neo->tileOffsetX + jitter4[sIndex + 2];
  (*(vuint32*)0x0400003C) = g_neo->tileOffsetY + jitter4[sIndex + 3];
  sIndex += 4;
  if(sIndex >= 8) sIndex = 0;
 } else {
  (*(vuint32*)0x04000028) = g_neo->tileOffsetX;
  (*(vuint32*)0x0400002C) = g_neo->tileOffsetY;
  (*(vuint32*)0x04000038) = g_neo->tileOffsetX;
  (*(vuint32*)0x0400003C) = g_neo->tileOffsetY;
 }

 (*(vuint16*)0x04000020) = g_neo->tileScaleX;
 (*(vuint16*)0x04000026) = g_neo->tileScaleY;
 (*(vuint16*)0x04000030) = g_neo->tileScaleX;
 (*(vuint16*)0x04000036) = g_neo->tileScaleY;
...
bool neoVideoInit()
{
 ...
 (*(vuint16*)0x04000008) = (2);

 (*(vuint16*) 0x04000060) = 1;
 (*(vuint32*) 0x04000580) =
  0 << 0 |
  0 << 8 |
  255 << 16 |
 ...
 (*(vuint32*) 0x04000480) = 0x7fff;

 (*(vuint32*) 0x04000350) = 0;
 (*(vuint16*) 0x04000354) = 0x7fff;


 (*(vuint32*)0x04000440) = 0;
 (*(vuint32*)0x04000454) = 0;
 (*(vuint32*)0x04000440) = 1;
 (*(vuint32*)0x04000454) = 0;
 (*(vuint32*)0x04000440) = 2;
 (*(vuint32*)0x04000454) = 0;
...
# 262 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/NeoVideo.c"
