# 1 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoSprites.arm.c"
...
# 2 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoSprites.arm.c" 2
...
# 5 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoSprites.arm.c" 2
# 1 "C:/Users/GRX/NeoDS/arm9/include/NeoMemory.h" 1
# 6 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoSprites.arm.c" 2
...
# 57 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoSprites.arm.c"
...
# 86 "C:/Users/GRX/NeoDS/arm9/source/NeoVideoSprites.arm.c"
void neoSpriteInit()
{
 s32 i;
 ...
 for(i = 0; i < ((512*(1<<10)) / ((1 << 3) * 128)); i++) {
  ...
  dmaCopyWords(3, g_spriteLoadBuffer, ((u8*)((u16*)0x6800000) + i * ((1 << 3) * 128)), ((1 << 3) * 128));
...
void neoDrawSprites()
{
 ...
 (*(vuint32*)(0x040000B4+(3*12))) = (u32)&(*(vu32*) 0x04000400);
 ...
 for(i = 0; i < 381; i++) {
  ...
  while(fxHeightToDraw > 0) {
   ...
   g_spriteTransferIndex < (64*(1<<10) / ((1 << 3) * 128))) {
    ...
    pLoadDst += ((1 << 3) * 128);
    pTransfer->pDst = ((u8*)((u16*)0x6800000) + cache1Index * ((1 << 3) * 128));
...
skipTile:
 ...
 while((*(vuint32*)(0x040000B0+(3*12))) & (1 << (31))) continue;
 while(((*(vu32*) 0x04000600) & (1 << (27)))) continue;
 g_spriteCount = (*(u16*) 0x04000604);
}
