# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiLabel.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiLabel.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiLabel.c" 2
...
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiLabel.c" 2

extern const TGuiTypeHeader __TGuiObjectTypeHeader__; static TGuiEventReturn __TGuiLabelTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__); const TGuiTypeHeader __TGuiLabelTypeHeader__ = { __TGuiLabelTypeHandler__, &__TGuiObjectTypeHeader__, sizeof(TGuiLabel), "TGuiLabel" }; static TGuiEventReturn __TGuiLabelTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiLabel* this __attribute__ ((unused)) = (TGuiLabel*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
...
void guiLabelSetTextv(TGuiLabel* this, const char* szFormat, ...)
{
 ...
 neoVsnprintf(this->szText, 32, szFormat, v);
 __builtin_va_end(v);
}
