# 1 "C:/Users/GRX/NeoDS-master-old/arm9/source/pd4990a.c"
# 1 "C:\\Users\\GRX\\NeoDS-master-old\\arm9\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/GRX/NeoDS-master-old/arm9/source/pd4990a.c"
# 10 "C:/Users/GRX/NeoDS-master-old/arm9/source/pd4990a.c"
...
# 11 "C:/Users/GRX/NeoDS-master-old/arm9/source/pd4990a.c" 2
...
# 14 "C:/Users/GRX/NeoDS-master-old/arm9/source/pd4990a.c" 2
...
void pd4990a_init(void) {
    ...
    pd4990a.seconds = 0x00;
    pd4990a.minutes = 0x00;
    pd4990a.hours = 0x00;
    pd4990a.days = 0x09;
    pd4990a.month = 9;
    pd4990a.year = 0x73;
...
void pd4990a_serial_control(unsigned char data)
{
  ...
  if(command_line && !(data&0x4))
  {
    pd4990a_process_command();
    pd4990a_resetbitstream();
  }
  command_line=data&0x4;

  if(clock_line && !(data&0x2))
  {
    pd4990a_writebit(data&0x1);
    pd4990a_nextbit();
  }
  clock_line=data&0x2;
}
