# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiMenu.c"
...
# 2 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiMenu.c" 2
...
TGuiObject* guiObjCreateChild_r(const TGuiTypeHeader* pType, TGuiObject* pParent,
     const TBounds* pBounds);
# 3 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiMenu.c" 2
...
# 5 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/guiMenu.c" 2

extern const TGuiTypeHeader __TGuiObjectTypeHeader__; static TGuiEventReturn __TGuiMenuTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__); const TGuiTypeHeader __TGuiMenuTypeHeader__ = { __TGuiMenuTypeHandler__, &__TGuiObjectTypeHeader__, sizeof(TGuiMenu), "TGuiMenu" }; static TGuiEventReturn __TGuiMenuTypeHandler__ (struct _TGuiObject* __pObj__, TGuiEventID e, void* __arg__) { TGuiMenu* this __attribute__ ((unused)) = (TGuiMenu*)__pObj__; TGuiEventReturn __ret__ = GUIEVENTRET_NOTHANDLED; switch(e) { case GUIEVENT_NULL: {
...
break; } case GUIEVENT_KEYREPEAT: { TGUIEVENT_KEYREPEATArg* arg __attribute__ ((unused)) = (TGUIEVENT_KEYREPEATArg*)__arg__;
{
...
break; } case GUIEVENT_KEYUP: { TGUIEVENT_KEYUPArg* arg __attribute__ ((unused)) = (TGUIEVENT_KEYUPArg*)__arg__;
{
 if(arg->keys & KEY_START) {
  guiObjSendEvent(&this->parent, GUIEVENT_SELECTED, ((void *)0));
 }
 __ret__ = GUIEVENTRET_HANDLED;
}
...
TGuiMenu* guiMenuCreateChild(TGuiObject* pParent, s32 itemMax, const TBounds* pBounds)
{
 TGuiMenu* this = ((TGuiMenu*)guiObjCreateChild_r(&__TGuiMenuTypeHeader__, pParent, pBounds));
...
void guiMenuAddItem(TGuiMenu* this, const char* szText)
{
 ...
 strncpy(pItem->szText, szText, 32);
 this->itemCount++;
 guiObjRenderDirty(&this->parent);
}
