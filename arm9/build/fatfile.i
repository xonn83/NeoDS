# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c"
# 1 "C:\\Users\\GRX\\NeoDS-GBMacro\\arm9\\build//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c"
# 45 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c"
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.h" 1
# 48 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.h"
...
# 49 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.h" 2
...
# 50 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.h" 2
...
# 52 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.h" 2
...
# 53 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.h" 2
...
# 46 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
...
# 48 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
# 1 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/../../../../arm-eabi/include/string.h" 1 3
# 14 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/../../../../arm-eabi/include/string.h" 3
# 1 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/include/stddef.h" 1 3 4
...
# 49 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
# 1 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/../../../../arm-eabi/include/errno.h" 1 3
...
# 1 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/../../../../arm-eabi/include/sys/errno.h" 1 3
# 15 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/../../../../arm-eabi/include/sys/errno.h" 3
...
# 10 "c:\\devkitpro\\devkitarm\\bin\\../lib/gcc/arm-eabi/4.1.1/../../../../arm-eabi/include/errno.h" 2 3
# 50 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
...
# 51 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
...
# 52 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
...
# 55 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
...
# 56 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2
...
# 57 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c" 2

u32 _FAT_cluster_lookup(FILE_STRUCT* file, u32 clusterTableIndex)
{
 if(file->clusterTable[clusterTableIndex] != 0x0000) {
 ...
 for(i = 1; i <= clusterTableIndex; i++) {
  if(file->clusterTable[i] == 0x0000) break;
...
int _FAT_open_r (struct _reent *r, void *fileStruct, const char *path, int flags, int mode) {
 ...
 if ((flags & 0x0200) && (flags & 0x0800) && fileExists) {
  r->_errno = 17;
  return -1;
 }
 ...
 if (!fileExists) {
  if (flags & 0x0200) {
   ...
   strncpy (dirEntry.filename, pathEnd, 256 - 1);
   memset (dirEntry.entryData, 0, 0x20);
...
# 223 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c"
 ...
 if ((flags & 0x0400) && file->write && (file->startCluster != 0)) {
 ...
 if (file->startCluster == 0) {
  file->startCluster = _FAT_fat_linkFreeCluster (partition, 0x0000);
 }
 ...
 file->appendPosition.sector = (file->filesize % partition->bytesPerCluster) / 512;
 file->appendPosition.byte = file->filesize % 512;
...
int _FAT_close_r (struct _reent *r, int fd) {
 ...
 if (file->write) {
  ...
  _FAT_cache_readPartialSector (file->partition->cache, dirEntryData,
   ...
   file->dirEntryEnd.offset * 0x20, 0x20);
...
int _FAT_read_r (struct _reent *r, int fd, char *ptr, int len) {
 ...
 tempVar = 512 - position.byte;
 if (tempVar > remain) {
  tempVar = remain;
 }

 if ((tempVar < 512) && flagNoError)
 {
 ...
 if (remain > (partition->sectorsPerCluster - position.sector) * 512) {
 ...
 if (position.sector >= partition->sectorsPerCluster) {
  ...
  if ((remain == 0) && (tempNextCluster == 0x0FFFFFFF)) {
   position.sector = partition->sectorsPerCluster;
  } else if (tempNextCluster == 0x0000) {
   r->_errno = 5;
   flagNoError = false;
  } else {
   position.sector = 0;
...
static bool file_extend_r (struct _reent *r, FILE_STRUCT* file) {
 ...
 position.byte = file->filesize % 512;
 position.sector = (file->filesize % partition->bytesPerCluster) / 512;
 ...
 if (remain + position.byte < 512) {
  ...
  while (remain >= 512) {
   if (position.sector >= partition->sectorsPerCluster) {
    position.sector = 0;
    tempNextCluster = _FAT_fat_nextCluster(partition, position.cluster);
    if ((tempNextCluster == 0x0FFFFFFF) || (tempNextCluster == 0x0000)) {

     tempNextCluster = _FAT_fat_linkFreeCluster(partition, position.cluster);
    }
    if (tempNextCluster == 0x0000) {
...
int _FAT_write_r (struct _reent *r,int fd, const char *ptr, int len) {
 ...
 if ((file == ((void *)0)) || !file->inUse || !file->write) {
  r->_errno = 9;
  return -1;
 }
...
int _FAT_seek_r (struct _reent *r, int fd, int pos, int dir) {
 ...
 if ((file == ((void *)0)) || (file->inUse == false)) {
 ...
 if (file->filesize > position) {
  ...
  file->rwPosition.sector = (position % partition->bytesPerCluster) / 512;
  file->rwPosition.byte = position % 512;
# 834 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/libfat/fatfile.c"
  ...
  cluster = _FAT_cluster_lookup(file, clusterTableIndex);

  nextCluster = _FAT_fat_nextCluster (partition, cluster);
  while(clusterTableOffset > 0 && nextCluster != 0x0000 && nextCluster != 0x0FFFFFFF) {
   clusterTableOffset--;
   cluster = nextCluster;
   nextCluster = _FAT_fat_nextCluster (partition, cluster);
  }
