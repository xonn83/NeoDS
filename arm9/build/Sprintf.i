# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/Sprintf.c"
# 1 "C:\\Users\\GRX\\NeoDS-GBMacro\\arm9\\build//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/Sprintf.c"
# 62 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/Sprintf.c"
...
# 63 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/Sprintf.c" 2
...
# 65 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/Sprintf.c" 2
...
# 111 "C:/Users/GRX/NeoDS-GBMacro/arm9/source/Sprintf.c"
  ...
  case 6:
   ...
   case 'i':
    if (cflags == 1)
     ...
     value = __builtin_va_arg(args,long int);
    else
     value = __builtin_va_arg(args,int);
   ...
   case 'o':
    ...
    if (cflags == 1)
     ...
     value = __builtin_va_arg(args,unsigned long int);
    else
     value = __builtin_va_arg(args,unsigned int);
   ...
   case 'x':
    ...
    break;
   case 'c':
    total += dopr_outch (buffer, &currlen, maxlen, __builtin_va_arg(args,int));
    break;
   case 's':
    strvalue = __builtin_va_arg(args,char *);
    total += fmtstr (buffer, &currlen, maxlen, strvalue, flags, min, max);
    break;
   case 'p':
    strvalue = __builtin_va_arg(args,void *);
